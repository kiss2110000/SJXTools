...
function getLayerProperty(prop,layer){
    if (prop === null)
    {
        alert(rd_GimmePropPath_localize(rd_GimmePropPathData.strErrNoSinglePropSel), rd_GimmePropPathData.scriptName);
        return
...
//~         alert("scriptCode:" + scriptCode);
        ...
        scriptCode = (0 ? "" : ".property") + "(" + name + ")" + scriptCode;
        // Traverse up the property tree
        currProp = currProp.parentProperty;
    }

//~     (propNameRefsByIndex) ? currProp.index : "\"" + currProp.name + "\"";
    name = layer.index ;
...
//~     {
//~         // Reference by property index
//~         if (currProp.parentProperty.propertyType === PropertyType.INDEXED_GROUP)
//~             name = currProp.propertyIndex;
//~         else
//~         {
//~             // Reference by match name or name
...
//~         }
//~         // 添加父级属性的路径
//~         propCode = ".property(" + name + ")" + propCode;
//~         
//~         // 更新当前属性为：父级属性
//~         currProp = currProp.parentProperty;
//~     }
...
//~ alert(prop.propertyType === PropertyType.INDEXED_GROUP)
//~ alert(prop.propertyType === PropertyType.NAMED_GROUP)
//~ alert(prop.selectedProperties)
//~ alert(getPropertyCode(prop))
//~ 没完成
